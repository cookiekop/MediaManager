...
from .connection_manager import CONNECTION_STATE
...
class ClientManager(object):
    ...
    def client_factory():
        ...
        client.config.app(
            USER_APP_NAME, CLIENT_VERSION, socket.gethostname(), str(uuid.uuid4())
        )
    ...
    def try_connect(self):
        credentials_location = "jellyfin_cred.json"
    ...
    def save_credentials(self):
        with open("jellyfin_cred.json", "w") as cf:
